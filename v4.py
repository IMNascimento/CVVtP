...
def main():
    ...
    # Caminhos intermediários dentro da pasta temporária
    caminho_audio_original = os.path.join(temp_dir, "audio_original.wav")
    caminho_audio_traduzido_bruto = os.path.join(temp_dir, "audio_traduzido_bruto.mp3")
    caminho_audio_traduzido_ajustado = os.path.join(temp_dir, "audio_traduzido_ajustado.mp3")
